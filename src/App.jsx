...
function SplashScreen({ userName, isNew=false }) {
  ...
  return (
    <div className="c-screen" style={{
      ...
      {/* Anneaux */}
      <div style={{position:"absolute",width:340,height:340,borderRadius:"50%",border:"1px solid #00e67618",top:"18%",left:"50%",marginLeft:"-170px",animation:"ring1 16s linear infinite"}}/>
      <div style={{position:"absolute",width:285,height:285,borderRadius:"50%",border:"1px dashed #76ff031a",top:"calc(18% + 27px)",left:"50%",marginLeft:"-142px",animation:"ring2 11s linear infinite"}}/>

      {/* ═══ SVG LOGO SE CONSTRUIT ═══ */}
      <div className="c-glow" style={{position:"relative",width:290,height:290,margin:"0 auto",flexShrink:0}}>
        <svg width="290" height="290" viewBox="0 0 290 290" xmlns="http://www.w3.org/2000/svg" style={{display:"block",margin:"0 auto"}}>
          <defs>
          ...
          {/* ── BALLON RÉEL depuis le logo ── */}
          <g className="c-ball">
            <image href={BALL_IMG}
              x="158" y="162" width="92" height="92"
              clipPath="none"
              style={{filter:"drop-shadow(2px 8px 8px rgba(0,0,0,0.7))"}}
            />
          </g>
        </svg>
