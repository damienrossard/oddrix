...
function SplashScreen({ userName }) {
  ...
  return (
    <div style={{
      ...
      <style>{`
        @keyframes b1Rise { 0%,5%{transform:scaleY(0);opacity:0} 25%{transform:scaleY(1.08);opacity:1} 35%,100%{transform:scaleY(1);opacity:1} }
        @keyframes b2Rise { 0%,12%{transform:scaleY(0);opacity:0} 32%{transform:scaleY(1.08);opacity:1} 42%,100%{transform:scaleY(1);opacity:1} }
        @keyframes b3Rise { 0%,20%{transform:scaleY(0);opacity:0} 40%{transform:scaleY(1.1);opacity:1} 50%,100%{transform:scaleY(1);opacity:1} }
        @keyframes b4Rise { 0%,28%{transform:scaleY(0);opacity:0} 48%{transform:scaleY(1.1);opacity:1} 58%,100%{transform:scaleY(1);opacity:1} }
        @keyframes b5Rise { 0%,36%{transform:scaleY(0);opacity:0} 56%{transform:scaleY(1.08);opacity:1} 66%,100%{transform:scaleY(1);opacity:1} }
        @keyframes lineGrow { 0%,30%{stroke-dashoffset:350;opacity:0} 65%,100%{stroke-dashoffset:0;opacity:1} }
        @keyframes dotAppear { 0%,55%{transform:scale(0);opacity:0} 70%{transform:scale(1.5);opacity:1} 80%,100%{transform:scale(1);opacity:1} }
        @keyframes circleTrace { 0%{stroke-dashoffset:600;opacity:0} 15%{opacity:1} 55%,100%{stroke-dashoffset:0;opacity:1} }
        @keyframes ballEntry {
          0%,40%{transform:translateY(250px) scale(0.3) rotate(0deg);opacity:0}
          55%{transform:translateY(-30px) scale(1.12) rotate(180deg);opacity:1}
          65%{transform:translateY(12px) scale(0.93) rotate(230deg);opacity:1}
          73%{transform:translateY(-12px) scale(1.05) rotate(270deg);opacity:1}
          80%{transform:translateY(4px) scale(0.98) rotate(300deg);opacity:1}
          87%{transform:translateY(-4px) scale(1.02) rotate(320deg);opacity:1}
          100%{transform:translateY(0px) scale(1) rotate(360deg);opacity:1}
        }
        @keyframes shadowBall { 0%,40%{transform:scaleX(0.1);opacity:0} 55%{transform:scaleX(1.3);opacity:0.4} 100%{transform:scaleX(1);opacity:0.25} }
        @keyframes logoReveal {
          0%,72%{opacity:0;transform:perspective(700px) rotateY(-60deg) scale(0.6)}
          85%{opacity:1;transform:perspective(700px) rotateY(8deg) scale(1.06)}
          93%{opacity:1;transform:perspective(700px) rotateY(-4deg) scale(0.98)}
        ...
        @keyframes greenGlow {
          0%,100%{filter:drop-shadow(0 0 12px #00e67633) drop-shadow(0 8px 24px #00000099)}
          50%{filter:drop-shadow(0 0 28px #76ff0355) drop-shadow(0 0 50px #00e67633) drop-shadow(0 8px 24px #00000099)}
        }
        @keyframes textPop { 0%,80%{opacity:0;transform:translateY(20px) scale(.9)} 92%{opacity:1;transform:translateY(-3px) scale(1.02)} 100%{opacity:1;transform:translateY(0) scale(1)} }
        @keyframes loadBar { from{width:0} to{width:100%} }
        @keyframes fadeIn { from{opacity:0} to{opacity:1} }
        @keyframes spark { 0%,100%{transform:translateY(0) scale(1);opacity:.4} 50%{transform:translateY(-22px) scale(1.4);opacity:.9} }
        @keyframes ring1 { to{transform:rotate(360deg)} }
        @keyframes ring2 { to{transform:rotate(-360deg)} }
        @keyframes reflectIn { from{opacity:0} to{opacity:.3} }
        .bar1{transform-origin:bottom center;animation:b1Rise 1s .1s cubic-bezier(.34,1.3,.64,1) both}
        .bar2{transform-origin:bottom center;animation:b2Rise 1s .1s cubic-bezier(.34,1.3,.64,1) both}
        .bar3{transform-origin:bottom center;animation:b3Rise 1s .1s cubic-bezier(.34,1.3,.64,1) both}
        .bar4{transform-origin:bottom center;animation:b4Rise 1s .1s cubic-bezier(.34,1.3,.64,1) both}
        .bar5{transform-origin:bottom center;animation:b5Rise 1s .1s cubic-bezier(.34,1.3,.64,1) both}
        .trend{stroke-dasharray:350;animation:lineGrow 1s .1s ease both}
        .d1{transform-origin:center;animation:dotAppear .4s .1s cubic-bezier(.34,1.6,.64,1) both}
        .d2{transform-origin:center;animation:dotAppear .4s .15s cubic-bezier(.34,1.6,.64,1) both}
        .d3{transform-origin:center;animation:dotAppear .4s .2s cubic-bezier(.34,1.6,.64,1) both}
        .d4{transform-origin:center;animation:dotAppear .4s .25s cubic-bezier(.34,1.6,.64,1) both}
        .d5{transform-origin:center;animation:dotAppear .4s .3s cubic-bezier(.34,1.6,.64,1) both}
        .circle-trace{stroke-dasharray:600;animation:circleTrace 1s .05s ease both}
        .ball-svg{animation:ballEntry 2s .2s cubic-bezier(.34,1.1,.64,1) both}
        .ball-shadow{animation:shadowBall 2s .2s ease both}
        .real-logo{animation:logoReveal 1.5s .1s cubic-bezier(.34,1.1,.64,1) both,logoFloat 3s 1.8s ease-in-out infinite,greenGlow 2.5s 1.8s ease-in-out infinite}
        .main-text{animation:textPop .6s .1s cubic-bezier(.34,1.3,.64,1) both}
      `}</style>
      ...
      {[...Array(10)].map((_,i)=>(
        <div key={i} style={{
          ...
          animation:`spark ${1.8+i*0.35}s ${i*0.2}s ease-in-out infinite`,
        }}/>
      ))}

      <div style={{position:"absolute",width:360,height:360,borderRadius:"50%",border:"1px solid #00e67610",animation:"ring1 14s linear infinite"}}/>
      <div style={{position:"absolute",width:300,height:300,borderRadius:"50%",border:"1px dashed #76ff0318",animation:"ring2 9s linear infinite"}}/>
      ...
      <div style={{position:"relative",width:260,height:260}}>
        <svg width="260" height="260" viewBox="0 0 260 260" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <linearGradient id="gCircle" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#3dff6e"/><stop offset="100%" stopColor="#76ff03"/>
            </linearGradient>
            <filter id="glow"><feGaussianBlur stdDeviation="2.5" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
            <filter id="ballShadow"><feDropShadow dx="0" dy="6" stdDeviation="4" floodColor="#000" floodOpacity=".5"/></filter>
            <radialGradient id="gBall" cx="38%" cy="32%">
              <stop offset="0%" stopColor="#ffffff"/><stop offset="40%" stopColor="#e8e8e8"/><stop offset="100%" stopColor="#aaaaaa"/>
            </radialGradient>
          </defs>
          <circle className="circle-trace" cx="118" cy="112" r="94" fill="none" stroke="url(#gCircle)" strokeWidth="4" strokeLinecap="round"/>
          <circle cx="118" cy="112" r="90" fill="#050d07" opacity=".9"/>
          <rect className="bar1" x="42"  y="148" width="18" height="22" rx="4" fill="url(#gBar1)" filter="url(#glow)"/>
          <rect className="bar2" x="66"  y="128" width="18" height="42" rx="4" fill="url(#gBar1)" filter="url(#glow)"/>
          <rect className="bar3" x="90"  y="104" width="18" height="66" rx="4" fill="url(#gBar1)" filter="url(#glow)"/>
          <rect className="bar4" x="114" y="82"  width="18" height="88" rx="4" fill="url(#gBar1)" filter="url(#glow)"/>
          <rect className="bar5" x="138" y="92"  width="18" height="78" rx="4" fill="url(#gBar1)" filter="url(#glow)"/>
          <polyline className="trend" points="42,150 66,128 90,100 114,76 140,54 162,36" fill="none" stroke="#00e676" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" filter="url(#glow)"/>
          <circle className="d1" cx="42"  cy="150" r="5" fill="#1de9b6" filter="url(#glow)"/>
          <circle className="d2" cx="66"  cy="128" r="5" fill="#1de9b6" filter="url(#glow)"/>
          <circle className="d3" cx="90"  cy="100" r="5" fill="#00e676" filter="url(#glow)"/>
          <circle className="d4" cx="114" cy="76"  r="5" fill="#00e676" filter="url(#glow)"/>
          <circle className="d5" cx="162" cy="36"  r="7" fill="#76ff03" filter="url(#glow)"/>
          <g className="ball-svg" filter="url(#ballShadow)">
            <circle cx="174" cy="178" r="38" fill="url(#gBall)"/>
            <polygon points="174,142 184,153 180,166 168,166 164,153" fill="#111" opacity=".85"/>
            <polygon points="174,214 164,203 168,190 180,190 184,203" fill="#222" opacity=".65"/>
            <polygon points="138,178 149,169 162,173 162,183 149,187" fill="#222" opacity=".65"/>
            <polygon points="210,178 199,187 186,183 186,173 199,169" fill="#222" opacity=".65"/>
            <ellipse cx="160" cy="157" rx="10" ry="6" fill="white" opacity=".35" transform="rotate(-30,160,157)"/>
          </g>
        </svg>
        <div className="ball-shadow" style={{position:"absolute",bottom:8,right:18,width:76,height:14,borderRadius:"50%",background:"radial-gradient(ellipse,#00000088,transparent)"}}/>
      </div>

      <div className="real-logo" style={{position:"absolute",width:260,display:"flex",flexDirection:"column",alignItems:"center"}}>
        <img src={ODDRIX_LOGO} alt="Oddrix" style={{width:260,height:"auto",objectFit:"contain",display:"block"}}/>
        <img src={ODDRIX_LOGO} alt="" style={{width:260,height:"auto",objectFit:"contain",transform:"scaleY(-1)",maskImage:"linear-gradient(to bottom,rgba(0,0,0,.25) 0%,transparent 55%)",WebkitMaskImage:"linear-gradient(to bottom,rgba(0,0,0,.25) 0%,transparent 55%)",marginTop:-18,animation:"reflectIn .4s 1.8s ease forwards",opacity:0}}/>
      </div>

      <div className="main-text" style={{textAlign:"center",marginTop:190}}>
        <div style={{color:"#8b949e",fontSize:13,fontWeight:600,letterSpacing:2,textTransform:"uppercase",marginBottom:6}}>
      ...
      <div style={{width:180,height:3,background:"#1a2a1a",borderRadius:2,marginTop:20,overflow:"hidden",animation:"fadeIn .3s 2s ease forwards",opacity:0}}>
        <div style={{height:"100%",borderRadius:2,background:"linear-gradient(90deg,#1de9b6,#76ff03,#1de9b6)",animation:"loadBar 1.5s 2.1s ease forwards",width:0}}/>
      </div>

      <div style={{position:"absolute",bottom:32,color:"#ffffff14",fontSize:10,letterSpacing:3,textTransform:"uppercase",animation:"fadeIn .3s 2.3s ease forwards",opacity:0}}>oddrix.fr</div>
    </div>
  );
}
// ── Onboarding (4 écrans) ─────────────────────────────────────────────────
